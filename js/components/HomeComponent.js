...
export default {
  ...
  <div id="client-testimonial-carousel" class="carousel slide" data-ride="carousel" >
    <div class="carousel-inner" role="listbox">
      ...
      ​<picture>
      <source   media="(min-width: 768px)" srcset="images/home_page/chat_bubble_desktop.svg"  type="image/svg+xml">
      <img  class="img-fluid " src="images/home_page/chat_bubble.svg" alt="chat bubble" />
          ...
          <button class="blue-btn">  <router-link class="router-link" to="/living_with_hiv">More info</router-link></button>
          </div>
      ...
      <img data-target="#client-testimonial-carousel" data-slide-to="0" class="active m-2"src="images/home_page/slide_dot_bold.svg"/>
      <img  data-target="#client-testimonial-carousel" data-slide-to="1" class=" m-2" src="images/home_page/slide_dot_dull.svg"/>
      <img  data-target="#client-testimonial-carousel" data-slide-to="2" class="m-2" src="images/home_page/slide_dot_dull.svg"/>
      </div>
      </div>
 ...
 <div class="know text-center container">
        ...
        <div>
            ...
            <p>Currently, over 30% of all new HIV infections globally are estimated to occur among youth ages 15 to 25 years. Also, increasingly, children infected at birth grow into adolescents who have to deal with their HIV positive status.  Combining the two, there is 5 million youth living with HIV. </p>
            <button class="blue-btn">  <router-link class="router-link" to="/living_with_hiv">More info</router-link></button>
            </div>
