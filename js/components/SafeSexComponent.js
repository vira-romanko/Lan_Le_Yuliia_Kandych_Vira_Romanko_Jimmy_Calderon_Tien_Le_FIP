export default {
    ...
    <img class="img-fluid col-md-6 float-right teens" src="images/hero_img_safe_sex.jpg" alt="hero img 1" />
      ...
      <div class="row  text-center justify-content-between align-items-center">
        ...
        <div class="col-lg-6 text-center text-md-right">
          <p>The criminal law considers that not telling a sexual partner your HIV-positive
            ...
            was HIV-positive.</p>
            <a href="http://teenhealthsource.com/sex/how-to-external-condom/" class="btn btn-red btn-animation-1">How to use</a>
    ...
    <div class="row   text-center justify-content-between align-items-center">
      ...
      <div class="col-lg-6  text-md-left">
        <p class="pt-4">Internal condoms look like pouches. In order to be effective at preventing HIV, insert internal condoms inside the vagina or anus during sex and use condoms that are made from polyurethane, or nitrile. Make sure you use a new condom each time you have sex.
          Lately, condoms haven’t been getting much love from young people, and this is causing a huge outbreak in STIs across Canada, including syphilis, which is making a comeback at rates we haven’t seen since 1948! </p>
          <a href="http://teenhealthsource.com/birthcontrol/how-to-use-an-internal-condom/" class="btn btn-red btn-animation-1">How to use</a>
      ...
      <div class="row text-center justify-content-between align-items-center">
        ...
        <div class="col-lg-6 text-center text-md-right">
          <p class="red-span"> <span>Consent and Checking In: </span>
            ...
            E.g. “Hey, is this ok?” “Are you ok with this?”</p>
