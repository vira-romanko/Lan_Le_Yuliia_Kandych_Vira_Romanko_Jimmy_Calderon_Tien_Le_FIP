export default {
    ...
    <div class="container">
    <div  class="d-flex row hiv-test hiv-box text-center pl-5 pr-5 pb-5">
    
    <h1 class="title text-center col m-4 p-4">What is an HIV test?</h1>
    
    <div>
    <p class="pt-4 red-span"><span>What To Expect!</span>
      ...
      <p class="pt-4 red-span"><span>How do I know if/ when I’m getting
      tested for HIV?</span>
      No matter what kind of HIV test you’re getting, your consent matters! Consent, in this case, means that it is your choice to have an HIV test, and no one can force you to have one if you do not want to. </p>
